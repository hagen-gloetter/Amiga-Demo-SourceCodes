...
Converter:
	...
	move	#218-1,d6
.lp2	swap	d6
	move	0*432(a0),d0		; pl0
	move	1*432(a0),d1		; pl1
	move	2*432(a0),d2		; pl2
	move	3*432(a0),d3		; pl3
	moveq	#16-1,d7
.lp	swap	d7
	rol	#1,d0
	rol	#1,d1
...
Pic:		incbin	`copanim/dose44x72x4.raw`
;Pic:		incbin	`copanim/head44x72x4.raw`
