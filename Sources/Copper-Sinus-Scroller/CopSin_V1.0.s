...
.wait	cmp	#1,demoflag	; wait till sprite is moved in
	bne.b	.wait
...
removeVBI:
	...
	move	#300,d7
.wait1	cmp.b	#255,6(a6)
	bne.b	.wait1
	dbf	d7,.wait1

.mlp	btst	#6,$bfe001		; Wait for left  mouse button
	bne.b	.mlp
...
AbspannText:	;******************||*******************`
	...
	dc.b	`                                       `
	dc.b	`DEEP SPACE NINE            07152 902518`
	dc.b	`                                       `
	dc.b	`---------------------------------------`
	dc.b	`                                       `
