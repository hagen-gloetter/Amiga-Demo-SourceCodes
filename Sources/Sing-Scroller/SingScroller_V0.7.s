;TOSAAAABEAHAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAPPPPOLPJ
;               T        T              T       T
...
ClearHiddenScreen:				; Clear Hidden Screen
	...
	move	#00,$66(a6)
	move.l	d1,$54(a6)
	move	#[197*64]+[320/16],$58(a6)	; etvl 200
...
CPU_Fill:	moveq	#0,d0		; Fill Font
	...
	qrept	197		; Höhe des zu füllenden Bereichs
	movem	(a1),d0/d2/d4/d6	; Neue Daten aus Bmp holen
	eor	d0,d1		;
	eor	d2,d3		;
	eor	d4,d5		;
	eor	d6,d7		;
	movem	d1/d3/d5/d7,(a1)	; Modifizierte Daten zurückschreiben
...
;---------------------------------------------------------- Font
	...
	cnop	0,8
FontTab	dc.w	35,37,29,40,28,29,35,37,14,24,34,28,42
	dc.w	34,41,34,41,38,28,35,38,41,41,32,36,31
