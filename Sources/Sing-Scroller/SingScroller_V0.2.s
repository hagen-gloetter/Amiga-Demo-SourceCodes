;TOSAAAABAEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAPPPPOPMA
;               T        T              T       T
...
.FrontScrToCop	lea	BitPlanes+2(pc),a1
	move	d0,4(a1)
	swap	d0
	move	d0,(a1)
...
.moveHiddenScroller
	...
	ble.b	.goOn
	bsr.w	NewChar
.goOn	lea	Hiddenscroller,a2	; Z D
	lea	16(a2),a1		; Q A 
	wblt
	move	#0,$64(a6)
	move	#0,$66(a6)
...
.no0:	move.l	a0,ScrollPtr
	...
	add	d1,d1	; /
	add	d1,d0	;/
.copyLetter	lea	(a1,d0.w),a0
	lea	HiddenScroller+15*320,a1
	wblt
	move	#0,$64(a6)
	move	#0,$66(a6)
	move.l	#$09f00000,$40(a6)
