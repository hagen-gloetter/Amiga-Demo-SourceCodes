;TOSAAAAAGCKAAAAAAABAAAAAAABAAAAAAABAAAAAAABAAAAAAABAAAAAAABAAAAAAABAAAAAAABPPPPPJMO
;               T        T              T       T

; © by Mirko und Hagen

; rewritten to 320 Pixel by Hagen on the 24.01.94 
; Hurra in 11 Monaten ist Weihnachten !

; Fnord hat 'ne Freundin !  Meine erste Frage war: Tier, Pflanze oder Mineral !
...
InitScreens	ml	#GameScreen+2400*4*40,d0	; init GameScreen
	lea	GamePlane+2,a0
	bsr	InitBplLoop
...
forw	mw	joywait,d0
	...
	lea	BlockPlane+2,a0
	mq	#0,d0
	ml	BlockScreenPtr,d0
	sub.l	#160*32,d0
	ml	d0,BlockScreenPtr
...
tabpointer	dc.l	0	; Pointer fuer die veraenderungen
			; im screen
GameX	dc.w	16	; ?pos im gamescreen
GameY	dc.w	2160+16
gamexold	dc.w	0
gameyold	dc.w	0	
...
BlockScreenPtr	dc.l	0	; welche reihe der blocks printen ?
BlockPos	dc.w	0	; auf welcher pos der blocks sind wir ?
lineMax	dc.w	0	; max. hoehe
xpos	dc.w	128	; anfans pos fuer das sprite!
...
cop:	dc.w	$106,$20,$1fc,%0000100
	dc.w	$180,0,$182,$aaa
	dc.w	$8e,$2181,$90,$41d1,$92,$38,$94,$d0
	dc.w	$102,0,$104,$10,$108,120,$10a,120
	dc.w	$100,$4200
...
;---------------------------------------------------------- Baukasten
	...
	incdir
Palette	inciffp	dh2:IFF/GamePics/block001
...
LevelTab	ds.w	11*10000
leveltabend:
	dc.w	$ffff

	incdir	Game:raw/
	cnop	0,8
Blocks	incbin	blockliste.b
BlockEnd	dc.b	`gnurz`
