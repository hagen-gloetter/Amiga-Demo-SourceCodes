...
CPUFill:	moveq	#0,d0
	...
	moveq	#0,d3
	moveq	#5-1,d6
.lp2:	move.l	a0,a1			; StartAdr sichern
	move	#84-1,d7		; Höhe des zu füllenden Bereichs
.lp:	movem.l	(a1),d0/d2		; Neue Daten aus Bmp holen
	eor.l	d0,d1			;
	eor.l	d2,d3			;
...
ScretchTab	include	logowobble2/WobbleTab2.i		; kommatabelle
	
;---------------------------------------------------------- Copperlist
	cnop	0,8
cop:	dc.w	$106,0,$1fc,0
	dc.w	$180,0,$182,$555
	dc.w	$8e,$7181,$90,$c4c1,$92,$38,$94,$d0
