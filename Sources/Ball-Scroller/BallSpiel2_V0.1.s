...
SinTab:		dcb.w	32,1
		dc.w	1,1,2,3,4,5,6,7		; 32 Werte
		dc.w	8,9,9,10,10,11,11
		dc.w	11,11,11,10,10,9,9
		dc.w	8,7,6,5,4,3,2,1,1

		incdir  dh1:code/sources/
Font:		incbin	`BallScroller/testfont8x8x3.raw`
Jumptab:	include	`BallScroller/jumptab.i`
...
BallScroll:	ds.w	160*64
BallScrollend	dc.l	$fffffffe
		ds.w	140
