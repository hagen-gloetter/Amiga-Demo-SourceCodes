...
.sinadd	lea	YSinTab(pc),a3
	...
	moveq	#0,d2
	move.b	#$80,d2
.scretch	moveq	#40-1,d7
.byteloop	moveq	#8-1,d6
.printMyDots	move	(a3)+,d0	; Sinus addieren
	rept	6
	move	(a1)+,d1
...
;---------------------------------------------------------- Includes
	...
	cnop	0,8
ScretchTab	include	logowaver/ScretchTab1.i		; kommatabelle
...
cop:	dc.w	$106,0,$1fc,0
	dc.w	$180,0,$182,$555
	dc.w	$8e,$6181,$90,$d1c1,$92,$38,$94,$d0
