...
ClearHiddenScreen:					; Clear Hidden Screen
	...
	move	#0,$66(a6)
	move.l	d1,$54(a6)
	move	#[Hoehe*64]+[Breite/2],$58(a6)

;---------------------------------------------------------- Do Main Effect

LogoScretch:	lea	SingLogo(pc),a1			; Logo Scretch
	lea	(a0),a5		; center logo
	lea	(a1),a2
...
.print	addq.b	#1,d5
	and.b	#$ff,d5
	add.b	(a4,d5.w),d3	; neue scretchstartpos
	move.b	d3,d4
	and.b	#$e,d3
	lsr.b	#4,d4
	beq.b	.redo
...
CPUFill:	moveq	#0,d0				; Fill Picture
	...
	move.l	a0,a1		; StartAdr sichern
	qrept	Hoehe-1		; Höhe des zu füllenden Bereichs
	movem.l	(a1),d0/d2/d4	; Neue Daten aus Bmp holen
	eor.l	d0,d1		;
	eor.l	d2,d3		;
	movem.l	d1/d3/d5,(a1)	; Modifizierte Daten zurückschreiben
	lea	Breite(a1),a1	; Eine Zeile tiefer 
	endqr
	rts
...
YSinTab:	include	logowaver/Sintab32-720.i	; ySinTab
	...
	cnop	0,8
SingLogo	incbin	logowaver/Motion5.192x90.Tab	; singtab
	dc.w	$ffff
	even

;	incdir	ram:
	cnop	0,8
ScretchTab	include	logowobble2/WobbleTab3.i
...
cop:	dc.w	$106,0,$1fc,0
	...
	dc.w	$8e,$3071,$90,$30e1,$92,$30,$94,$d8
...
Screen1:	ds.b	256*Breite
Screen2:	ds.b	256*Breite
Screen3:	ds.b	256*Breite
