...
SPRITEINIT	lea	TestSprite+2,a0
	move.l	#SprData,d0
	move	d0,4(a0)
	swap	d0
	move	d0,0(a0)
...
CalcCW:
	lea	SprData,a0	; a0/d2/d0-d1 | Sprdaten/Sprhöhe/x-ypos
	moveq	#0,d3
	move.b	d1,(a0)			; E0-E7
	btst	#8,d1
	beq.b	.noE8
