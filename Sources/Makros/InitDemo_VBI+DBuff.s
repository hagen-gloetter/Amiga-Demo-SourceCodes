...
VBI:	movem.l	d0-d7/a0-a6,-(a7)
	lea	$dff000,a6
.DBuff:	lea	Screen1(pc),a2
	movem.l	(a2),d0-d1
	exg	d0,d1
	movem.l	d0-d1,(a2)
.Front:	lea	Planes+2(pc),a2
	moveq	#4-1,d7
.lp:	move	d0,4(a2)	;  Low-Word
	swap	d0
	move	d0,(a2)		; High-Word
	swap	d0
	add	#10240,d0
	addq	#8,a2
	dbf	d7,.lp
...
Screen1:	dc.l	FrontScreen
Screen2:	dc.l	HiddenScreen
FrontScreen:	ds.b	4*10240
HiddenScreen:	ds.b	4*10240
