...
;	zu finden, bis ich bemerkte, daß dpaint Scheiße gebaut hat ! ARRRGGG !
...
Converter:	; Converts a Brush 32x32x5 (+cols) to Coppercolors
	...
	moveq	#0,d1
	moveq	#0,d3
	moveq	#4-1,d6		; Zeile		(Breite in Byte)
...
yzoom:
	...
	move	#140-1,d7
	move	#140-1,d5	; abbruchzähler
.lp 	and	#$1f,d1			; kommastelle isolieren
	add	d0,d1
	move	d1,d2
	and	#$f0,d2
	lsl	#8,d2
