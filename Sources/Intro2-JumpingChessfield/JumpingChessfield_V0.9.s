...
;		   by Duke of Haze on the 30.11.93
	...
	section	ChessField,code_c	; code to chipmem
...
Cop:	dc.w	$106,$c00,$1fc,0		; AGA-Fix
	dc.w	$8e,$3091,$90,$30c7,$92,$38,$94,$d0
	dc.w	$104,$0,$108,0,$10a,-40
	dc.w	$100,$5600	; 5pl+dpl
...
Logo		incbin	`intro2/Motion320x80x3.raw`
VRaster:	incbin	`intro2/Raster320x160x1.raw`

;---------------------------------------------------------- JumpTab

VHRasttab:	include	`intro2/jumptab.s`	; Tab from 0 to 160  256 values
